...
module.exports = Marionette.View.extend({
    ...
    defaults: {
        ...
        animationClass: 'ui-animated',
        className: 'ui-stack ui-scroll-content',
        itemClass: 'ui-stack-item view',
        hiddenClass: "ui-stack-hidden"
    },
    ...
    pop: function(options) {
        ...
        if (this.views.length > (this.hasRootView ? 1 : 0)) {
            ...
            if (options.transition || this.useDefaultTransitions) {
                ...
                newView.$el.removeClass(this.options.hiddenClass);
                view.close();
            }
        }
    },
    ...
    push: function(view, options) {
        ...
        if (transition || this.useDefaultTransitions) {
            ...
            if (oldView) {
                oldView.$el.addClass(this.options.hiddenClass);
            }
            view.render();
            this.$el.append(view.$el);
